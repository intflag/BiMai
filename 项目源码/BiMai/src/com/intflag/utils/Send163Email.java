...
public class Send163Email {
		...
		String from = "15848644100@163.com"; 				// 邮件发送人的邮件地址
		String to = email; 										// 邮件接收人的邮件地址
		final String username = "15848644100@163.com";  	//发件人的邮件帐户
		final String password = "include047740";   					//发件人的邮件密码
		...
		try {
			...
			//设置主题
			message.setSubject("[必买商城] 用户激活验证");
			//设置邮件的文本内容
